/**
 * This instantiates the ReactiveBeacon instance, a reactive data source for beacon information for currently
 ...
 * @constructor
 */
ReactiveBeacons = function(beaconRegion, disableMonitoring, disableRanging) {
 ...
 * @returns {Array}
 */
ReactiveBeacons.prototype.getBeaconRegion = function() {
    this.dep.depend();
 ...
 * @returns {*}
 */
ReactiveBeacons.prototype.areBeaconsUpdated = function(newBeacons) {
